 ...
 * @author david
 */
public class TcpEventTimerQueue extends TimerTask {
    ...
    public TcpEventTimerQueue(LinkedBlockingQueue<String> lbq, ArrayList<String> lines, Integer numToSend, Integer numPerSec, TcpSenderThread[] threads) {
        this.lbq = lbq;
        this.lines = lines;
            ...
            if (cnt >= numToSend) {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        Logger.getLogger(TcpEventTimerQueue.class.getName()).log(Level.SEVERE, null, ex);
                    }
